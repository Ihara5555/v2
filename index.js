...
const connect = async () => {
  let _0x56620b = await axios.get('https://raw.githubusercontent.com/Ihara5555/Md77/refs/heads/main/main/main_ver.json');
...
async function connectToWA() {
  ...
  const _0x2a242b = (await axios.get("https://raw.githubusercontent.com/Ihara5555/Md77/refs/heads/main/main/main_ver.json")).data;
  const {
    state: _0x2427b2,
    saveCreds: _0xfe11da
    ...
    if (_0x9fdb01 === "close") {
      ...
      setTimeout(async () => {
        try {
          ...
          try {
            const _0x57d14d = await axios.get("https://raw.githubusercontent.com/Ihara5555/Md77/refs/heads/main/main/main_ver.json");
  ...
  _0x55533e.ev.on("messages.upsert", async _0x4b9a40 => {
    try {
      ...
      const _0x1e815c = (await axios.get("https://raw.githubusercontent.com/Ihara5555/Md77/refs/heads/main/main/main_ver.json")).data;
      ...
      const _0x5f1ee4 = (await axios.get("https://raw.githubusercontent.com/Ihara5555/Md77/refs/heads/main/main/main_ver.json")).data;
